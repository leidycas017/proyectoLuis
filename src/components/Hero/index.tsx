          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-5xl font-black leading-tight text-[#EA602C] dark:text-white sm:text-5xl sm:leading-tight md:text-5xl md:leading-tight">
                  <span style={{ fontWeight: "900" }}>
                    VENTA DE TRUCHA FRESCA
                  </span>
                </h1>

                <p className="mb-12 text-lg !leading-relaxed text-black dark:text-body-color-dark sm:text-lg md:text-lg">
                  Altos de Mazzarello, Retiro, Antioquia
                </p>
